    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('i_id', models.PositiveIntegerField(primary_key=True, serialize=False, db_column='study_id', verbose_name='global study id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_trait_id', models.PositiveIntegerField(primary_key=True, serialize=False, db_column='i_trait_id', verbose_name='phenotype id')),
                ...
                ('i_unit', models.CharField(verbose_name='unit', blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_id', models.PositiveIntegerField(primary_key=True, serialize=False, db_column='i_id', verbose_name='id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_id', models.PositiveIntegerField(primary_key=True, serialize=False, db_column='i_id', verbose_name='harmonized trait set id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_id', models.PositiveIntegerField(primary_key=True, serialize=False, db_column='i_id', verbose_name='dataset id')),
                ...
                ('i_visit_code', models.CharField(verbose_name='visit code', blank=True, max_length=100)),
                ('i_visit_number', models.CharField(verbose_name='visit number', blank=True, max_length=45)),
                ('i_is_subject_file', models.BooleanField(verbose_name='is subject file?')),
                ('i_study_subject_column', models.CharField(verbose_name='study subject column name', blank=True, max_length=45)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_id', models.PositiveIntegerField(primary_key=True, serialize=False, db_column='i_id', verbose_name='source study version id')),
                ('i_version', models.PositiveIntegerField(verbose_name='version')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('i_trait_name', models.CharField(verbose_name='phenotype name', max_length=100)),
                ('i_description', models.TextField(verbose_name='description')),
                ('i_detected_type', models.CharField(verbose_name='detected type', blank=True, max_length=100)),
                ('i_dbgap_type', models.CharField(verbose_name='dbGaP type', blank=True, max_length=100)),
                ('i_visit_number', models.CharField(verbose_name='visit number', blank=True, max_length=45)),
                ...
                ('i_dbgap_unit', models.CharField(verbose_name='dbGaP unit', blank=True, max_length=45)),
                ('i_n_records', models.PositiveIntegerField(blank=True, null=True, verbose_name='n records')),
                ('i_n_missing', models.PositiveIntegerField(blank=True, null=True, verbose_name='n missing')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_accession', models.PositiveIntegerField(primary_key=True, serialize=False, db_column='i_accession', verbose_name='study accession')),
