    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('i_id', models.PositiveIntegerField(db_column='study_id', serialize=False, verbose_name='global study id', primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_trait_id', models.PositiveIntegerField(db_column='i_trait_id', serialize=False, verbose_name='phenotype id', primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_id', models.PositiveIntegerField(db_column='i_id', serialize=False, verbose_name='id', primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_id', models.PositiveIntegerField(db_column='i_id', serialize=False, verbose_name='harmonized trait set id', primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_id', models.PositiveIntegerField(db_column='i_id', serialize=False, verbose_name='dataset id', primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_id', models.PositiveIntegerField(db_column='i_id', serialize=False, verbose_name='source study version id', primary_key=True)),
                ('i_version', models.PositiveIntegerField(verbose_name='version')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('i_accession', models.PositiveIntegerField(db_column='i_accession', serialize=False, verbose_name='study accession', primary_key=True)),
