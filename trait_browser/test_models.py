...
class HarmonizedTraitSetTestCase(TestCase):
    ...
    def test_get_trait_names(self):
        ...
        hts = factories.HarmonizedTraitSetFactory.create()
        htraits = factories.HarmonizedTraitFactory.create_batch(5, harmonized_trait_set=hts)
        hts.refresh_from_db()
...
class HarmonizationUnitTestCase(TestCase):
    ...
    def test_adding_component_harmonized_trait_sets(self):
        """Test that adding associated component_harmonized_trait_sets works."""
        component_harmonized_trait_sets = factories.HarmonizedTraitSetFactory.create_batch(5)
        harmonization_unit = factories.HarmonizationUnitFactory.create(
            component_harmonized_trait_sets=component_harmonized_trait_sets)
        self.assertEqual(len(harmonization_unit.component_harmonized_trait_sets.all()), 5)
...
class HarmonizedTraitTestCase(TestCase):
    ...
    def test_custom_save(self):
        ...
        self.assertEqual(
            ...
            '{}_{}'.format(harmonized_trait.i_trait_name, harmonized_trait.harmonized_trait_set.i_flavor))
    ...
    def test_adding_component_harmonized_trait_sets(self):
        ...
        harmonized_trait = factories.HarmonizedTraitFactory.create(
            component_harmonized_trait_sets=component_harmonized_trait_sets)
        self.assertEqual(len(harmonized_trait.component_harmonized_trait_sets.all()), 5)

    def test_adding_harmonization_units(self):
        """Test that adding associated harmonization_units works."""
        htrait_set = factories.HarmonizedTraitSetFactory.create()
        harmonization_units = factories.HarmonizationUnitFactory.create_batch(5, harmonized_trait_set=htrait_set)
