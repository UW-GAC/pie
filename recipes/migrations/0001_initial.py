    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encoded_values', models.TextField(validators=[django.core.validators.RegexValidator(regex='^(.*: .*\\n)*(.*: .*)$', message='Invalid format for encoded values definitions.')], verbose_name='definition of encoded values for target variable', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_variables', models.ManyToManyField(related_name='units_as_batch_trait', blank=True, to='trait_browser.SourceTrait')),
