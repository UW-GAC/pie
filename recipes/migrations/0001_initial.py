    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(verbose_name='harmonization recipe name', max_length=1000)),
                ('version', models.IntegerField(default=1)),
                ('target_name', models.CharField(verbose_name='target phenotype variable name', max_length=50)),
                ('target_description', models.CharField(verbose_name='target phenotype variable description', max_length=1000)),
                ('encoded_values', models.TextField(blank=True, verbose_name='definition of encoded values for target variable')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(default=1)),
                ('name', models.CharField(verbose_name='harmonization unit name', max_length=1000)),
                ('age_variables', models.ManyToManyField(related_name='units_as_age_trait', to='trait_browser.SourceTrait')),
                ('batch_variables', models.ManyToManyField(related_name='units_as_batch_trait', to='trait_browser.SourceTrait')),
